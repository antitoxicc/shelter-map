...
const NON_DESCRIPTIVE_PATTERNS = [
  "Ð¸Ð¼Ð¿Ð¾Ñ€Ñ‚Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð¾ Ð¸Ð· ÑÐ¾Ð¿Ð¾ÑÑ‚Ð°Ð²Ð»ÐµÐ½Ð½Ñ‹Ñ… Ñ„Ð°Ð¹Ð»Ð¾Ð²",
  "Ñ‚Ñ€ÐµÐ±ÑƒÐµÑ‚ÑÑ Ð¿Ñ€Ð¾Ð²ÐµÑ€ÐºÐ°",
...
const LOCATION_VERIFICATION_LABELS = {
  ...
  approximate: "ÐÑƒÐ¶Ð½Ð¾ Ð¿Ñ€Ð¾Ð²ÐµÑ€Ð¸Ñ‚ÑŒ",
  needs_review: "ÐÑƒÐ¶Ð½Ð¾ Ð¿Ñ€Ð¾Ð²ÐµÑ€Ð¸Ñ‚ÑŒ"
};
...
function getNormalizedVerificationLabel(value) {
  ...
  return "ÐÑƒÐ¶Ð½Ð¾ Ð¿Ñ€Ð¾Ð²ÐµÑ€Ð¸Ñ‚ÑŒ";
}
...
function getDescriptionSignalForPoint(point) {
  ...
  if (!text && !point?.media_url) {
    return { className: "weak", label: "ÃÅ¾ÃÂ¿ÃÂ¸Ã‘ÂÃÂ°ÃÂ½ÃÂ¸Ã‘Â ÃÂ½ÃÂµÃ‘â€š" };
  }

  if (isMeaningfulDescription(text, point)) {
    return { className: "strong", label: "Ãâ€¢Ã‘ÂÃ‘â€šÃ‘Å’ ÃÂ¿ÃÂ¾ÃÂ½Ã‘ÂÃ‘â€šÃÂ½ÃÂ¾ÃÂµ ÃÂ¾ÃÂ¿ÃÂ¸Ã‘ÂÃÂ°ÃÂ½ÃÂ¸ÃÂµ" };
  }

  return { className: "weak", label: "ÃÅ¾ÃÂ¿ÃÂ¸Ã‘ÂÃÂ°ÃÂ½ÃÂ¸ÃÂµ ÃÂ½Ã‘Æ’ÃÂ¶ÃÂ½ÃÂ¾ Ã‘Æ’Ã‘â€šÃÂ¾Ã‘â€¡ÃÂ½ÃÂ¸Ã‘â€šÃ‘Å’" };
}
